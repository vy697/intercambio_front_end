...
app.service('searchService', ['localizeService', '$http', '$window', function(localizeService, $http, $window) {
 ...
 // data (list of matches) from findMatches stored here.
  ...
  sv.findMatchesForUser = function(i_speak, i_learn, city, lang_preference) {
    ...
    return $http.get('http://localhost:3000/search/results', {params:{"i_speak": i_speak, "i_learn": i_learn, "city": city, "lang_preference": lang_preference}})
    .then(function(data) {
...
app.service('userService', ['searchService', '$http', '$window', function(searchService, $http, $window) {
